  ...
  return (
    ...
    >
      <Flex flexDir={'column'} w={'30%'} borderRight={'1px solid rgba(219, 219, 219, 1)'} h={'100%'}>
        ...
        <Box h={'90%'} display={'flex'} flexDir={'column'} gap={2} overflowY={'auto'}>
          <HStack p={2} mt={1} bg={'#efefef'}>
            <Avatar size={'md'}></Avatar>
            <Text fontWeight={'400'} fontSize={'16px '} fontFamily={'Roboto'} textAlign={'center'} >Chirag Singla</Text>
          </HStack>
          <HStack p={2} bg={'#efefef'}>
            <Avatar size={'md'}></Avatar>
            <Text fontWeight={'400'} fontSize={'16px '} fontFamily={'Roboto'} textAlign={'center'} >Chirag Singla</Text>
          </HStack>
          <HStack p={2} bg={'#efefef'}>
      ...
      <Flex w={'70%'} h={'100%'} flexDir={'column'}>
        <HStack borderBottom={'1px solid rgba(219, 219, 219, 1)'}  justifyContent={'space-between'} px={2} h={'10%'} w={'100%'} >
          <HStack p={2} >
          ...
          <HStack>
            <Image cursor={'pointer'} src={CallIcon} alt={'call icon'} />
            <Image cursor={'pointer'} src={VideoCallIcon} alt={'video call icon'} />
