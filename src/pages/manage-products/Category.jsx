...
import CategorysApi from "../../apis/products.api";
import { productsCatagoryTable } from "../../redux/redux-slice/tableData.slice";
const Index = () => {
    ...
    const categoryApi = new CategorysApi()
    ...
    const data = useSelector((state) => state.tableDataSlice.productCategory)
    const getAllCategory = async () => {
        ...
        try {
            ...
            if (getAllCategoryResponse.data.code === 200) {
                dispatch(productsCatagoryTable(getAllCategoryResponse.data.data));
                setLoading(false);
            } else {
    ...
    const DeleteHandler = async (id) => {
        try {
            const getAllCategoryResponse = await categoryApi.deleteCategoryById({
                categoryId: id
            })
            if (getAllCategoryResponse.data.code === 200) {
                toast.success(getAllCategoryResponse.data.message);
                getAllCategory()
            } else {
                toast.error(getAllCategoryResponse.data.message);
            }
                ...
                <div className="w-full  ">
                    ...
                    <div className="flex items-center justify-between gap-4">
                        <button type="button"
                            ...
                            onClick={() => Navigate('/manage-products/category/register')}>
                                                ...
                                                >
                                                    ...
                                                    <td
                                                        ...
                                                        <DropdownEditMenu align="right" className="relative inline-flex">
                                                            <li>
                                                                <Link to={`/manage-products/category/register/?id=${data?.categoryId}`}>
